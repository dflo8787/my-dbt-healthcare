...
INSERT INTO li_ws.second_brain.architecture_decisions VALUES
  ('DECISION-001', '2026-03-01',
   ...
   'Dennis Flomo', 'profiles.yml, .mcp.json', current_timestamp()),
  ('DECISION-002', '2026-03-01',
   ...
   'Dennis Flomo', 'FEATURE_REQUEST.md, pipeline-orchestrator.md', current_timestamp()),
  ('DECISION-003', '2026-03-01',
   ...
   'Dennis Flomo', 'data-quality-scanner.md', current_timestamp()),
  ('DECISION-004', '2026-04-01',
   ...
   'Dennis Flomo', 'Cheat sheet Sections 15-20', current_timestamp()),
  ('DECISION-005', '2026-04-01',
   ...
   'Dennis Flomo', 'pipeline-orchestrator.md', current_timestamp()),
  ('DECISION-006', '2026-04-01',
   ...
   'Dennis Flomo', 'gate.md, CLAUDE.md', current_timestamp()),
  ('DECISION-007', '2026-04-01',
   ...
   'Dennis Flomo', 'MODEL_ROUTING.md, dbt-runner-agent.md', current_timestamp()),
   ('DECISION-008', '2026-04-15',
   'root-cause-tracer uses diagnosis-only pattern',
   'Designing failure recovery in the pipeline',
   'Auto-fix vs diagnosis-only vs human-only',
   'Diagnosis agent writes ROOT_CAUSE_REPORT.md. Human or orchestrator applies fix. Prevents cascading failures.',
   'Implemented in root-cause-tracer.md and .agent/roles/debugger.md.',
   'Dennis Flomo', 'root-cause-tracer.md, .agent/roles/debugger.md', current_timestamp());
```
